...
fn project_path(env_projects_str: &str, name: &str) -> String {
    Path::new(env_projects_str)
        .join(name)
        .components()
...
fn test_settings_json_with_projects(env_projects_str: &str) -> String {
    serde_json::json!({
        "userProjects": defined_projects_in_settings_json(env_projects_str),
    })
    .to_string()
}
...
fn defined_projects_in_settings_json(env_projects_str: &str) -> Vec<String> {
    [
        project_path(env_projects_str, "Blank 2019 project"),
        project_path(env_projects_str, "Blank 2022 project"),
        project_path(env_projects_str, "HistoryOfAvatarOptimizer"),
        project_path(env_projects_str, "VPMPackageAutoInstaller"),
        project_path(env_projects_str, "CrashOnExitWithLogTypeFullName"),
    ]
    .into_iter()
    .sorted()
    .collect_vec()
        ...
        .insert(
            ...
            vec![
                ...
                vrc_get_litedb::document! {
                    "Path" => project_path(env_projects_str, "HistoryOfAvatarOptimizer"),
                ...
                vrc_get_litedb::document! {
                    "Path" => project_path(env_projects_str, "VPMPackageAutoInstaller"),
                    "UnityVersion" => "2022.3.22f1",
                    "CreatedAt" => DateTime::now(),
                    "LastModified" => DateTime::now(),
                    "Type" => ProjectType::Avatars as i32,
                ...
                vrc_get_litedb::document! {
                    "Path" => project_path(env_projects_str, "CrashOnExitWithLogTypeFullName"),
                    "UnityVersion" => "2022.3.22f1",
                    "CreatedAt" => DateTime::now(),
                    "LastModified" => DateTime::now(),
                    "Type" => ProjectType::Avatars as i32,
                ...
                vrc_get_litedb::document! {
                    "Path" => project_path(env_projects_str, "New Project 32"),
                    "UnityVersion" => "2022.3.22f1",
                    "CreatedAt" => DateTime::now(),
                    "LastModified" => DateTime::now(),
                    "Type" => ProjectType::Avatars as i32,
                ...
                vrc_get_litedb::document! {
                    "Path" => project_path(env_projects_str, "New Project 31"),
                    "UnityVersion" => "2022.3.22f1",
                    "CreatedAt" => DateTime::now(),
                    "LastModified" => DateTime::now(),
                    "Type" => ProjectType::Avatars as i32,
...
fn defined_projects_in_litedb(env_projects_str: &str) -> Vec<String> {
    [
        ...
        project_path(env_projects_str, "VPMPackageAutoInstaller"),
        project_path(env_projects_str, "CrashOnExitWithLogTypeFullName"),
        project_path(env_projects_str, "New Project 32"),
        project_path(env_projects_str, "New Project 31"),
    ]
    .into_iter()
    .sorted()
    .collect_vec()
...
/// When no settings.json is there, we treat userProjects as absent and use vcc.litedb
