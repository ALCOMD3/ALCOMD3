...
- Release workflow: [RELEASE.ja.md](../RELEASE/RELEASE.ja.md)
...
- Updater signing and verification: [ALCOMD3_UPDATER.ja.md](../ALCOMD3_UPDATER/ALCOMD3_UPDATER.ja.md)
- Product/release shared config: [../../alcomd3.config.json](../../alcomd3.config.json)
