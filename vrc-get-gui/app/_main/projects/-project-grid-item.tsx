...
export function ProjectGridItem({
	...
	return (
		...
		>
			<Card
				className={`relative p-4 bg-card flex flex-col gap-2 group compact:p-2 compact:pl-3 compact:gap-1 ${
					removed || loading || !(project.is_valid ?? true) ? "opacity-50" : ""
				}`}
			>
				...
				<div className="flex flex-row flex-wrap gap-x-1 gap-y-0 text-xs text-muted-foreground">
					<div>
