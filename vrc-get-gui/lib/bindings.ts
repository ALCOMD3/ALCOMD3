...
export const commands = {
	activityGetEntries: (filter: ActivityEntryFilter) => __TAURI_INVOKE<ActivityEntry[]>("activity_get_entries", { filter }),
	activityOpenLogFolder: () => __TAURI_INVOKE<null>("activity_open_log_folder"),
	...
	environmentRestoreProjectFromBackup: (channel: string, backupPath: string, projectName: string) => __TAURI_INVOKE<AsyncCallResult<TauriRestoreProjectFromBackupProgress, TauriRestoreProjectFromBackupResult>>("environment_restore_project_from_backup", { channel, backupPath, projectName }),
	...
	environmentDefaultRepositories: () => __TAURI_INVOKE<TauriDefaultRepository[]>("environment_default_repositories"),
	environmentRepositoryPackageLists: () => __TAURI_INVOKE<TauriRepositoryPackageList[]>("environment_repository_package_lists"),
	...
	environmentSetAutomaticUpdate: (automaticUpdate: boolean) => __TAURI_INVOKE<null>("environment_set_automatic_update", { automaticUpdate }),
	...
	projectPackageRows: (projectPath: string) => __TAURI_INVOKE<TauriProjectPackageRows>("project_package_rows", { projectPath }),
	...
	utilFrontendReady: () => __TAURI_INVOKE<null>("util_frontend_ready"),
	utilCheckForUpdate: (manual: boolean) => __TAURI_INVOKE<{
	version: number,
	current_version: string,
	latest_version: string,
	updater_status: UpdaterStatus,
	automatic_update_handled: boolean,
	automatic_download: boolean,
	update_downloaded: boolean,
	update_description: string | null,
	update_description_localizations: { [key in string]: string } | null,
	updater_disabled_messages: { [key in string]: string } | null,
} | null>("util_check_for_update", { manual }),
	utilDownloadUpdate: (channel: string, automatic: boolean, version: number) => __TAURI_INVOKE<AsyncCallResult<UpdateDownloadProgress, null>>("util_download_update", { channel, automatic, version }),
	utilInstallDownloadedUpdate: () => __TAURI_INVOKE<null>("util_install_downloaded_update"),
...
export type ActivityEntryFilter = {
...
export type ActivityImportance = "Primary" | "Secondary" | "Technical";

export type ActivityKind = "Read" | "Write" | "Passive" | "Open" | "Maintenance";

export type ActivitySource = "Gui" | "Mcp" | "DeepLink" | "System";

export type ActivityStatus = "Started" | "Succeeded" | "Failed" | "Cancelled" | "Info";
...
export type UpdateDownloadProgress = { type: "DownloadProgress"; received: number; total: number | null } | { type: "DownloadComplete" };
...
export type SetupPages = "Appearance" | "LegacyImport" | "UnityHub" | "ProjectPath" | "Backups" | "SystemSetting";
...
export type TauriBackupNameCheckResult = "InvalidNameForFileName" | "AlreadyExists" | "Ok";
...
export type TauriDefaultRepository = {
	id: string,
	url: string,
	kind: string,
};
...
export type TauriLegacyDataImportCategory = "Projects" | "Resources" | "Theme" | "Settings";

export type TauriLegacyDataImportResult = {
	imported_settings: boolean,
	imported_database: boolean,
	imported_repositories: boolean,
	imported_vcc_templates: boolean,
	imported_alcom_templates: boolean,
	imported_vrc_get_settings: boolean,
	imported_gui_config: boolean,
};

export type TauriLegacyDataSource = {
	kind: TauriLegacyDataSourceKind,
	display_name: string,
	path: string,
};

export type TauriLegacyDataSourceKind = "Vcc" | "Alcom" | "Alcomd3Beta";
...
export type TauriPickProjectBackupForRestoreResult = { type: "NoFileSelected" } | { type: "InvalidSelection" } | { type: "Successful"; backup_path: string; project_name: string; project_location: string };
...
export type TauriProjectBackupCreationInformation = {
...
export type TauriProjectPackageInstalled = {
	version: TauriVersion,
	yanked: boolean,
};

export type TauriProjectPackageLatestInfo = { status: "none" } | { status: "contains"; pkg: TauriPackage; has_unity_incompatible_latest: boolean } | { status: "upgradable"; pkg: TauriPackage; has_unity_incompatible_latest: boolean };

export type TauriProjectPackageRow = {
	id: string,
	info_source: TauriVersion,
	display_name: string,
	description: string,
	keywords: string[],
	unity_compatible: TauriPackage[],
	unity_incompatible: TauriPackage[],
	sources: string[],
	is_there_source: boolean,
	visible_sources: string[],
	installed: TauriProjectPackageInstalled | null,
	latest: TauriProjectPackageLatestInfo,
	stable_latest: TauriProjectPackageLatestInfo,
	changelog_url: TauriProjectPackageUrlInfo | null,
	documentation_url: TauriProjectPackageUrlInfo | null,
};

export type TauriProjectPackageRows = {
	project: TauriProjectDetails,
	packages: TauriProjectPackageRow[],
};

export type TauriProjectPackageUrlInfo = {
	url: string,
...
export type TauriRepositoryPackageList = {
	repository_id: string,
	packages: TauriBasePackageInfo[],
};

export type TauriRestoreProjectFromBackupProgress = {
	total: number,
	proceed: number,
	last_proceed: string,
};
...
export type UpdateReminderConfig = {
