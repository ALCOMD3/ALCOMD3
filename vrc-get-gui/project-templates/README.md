...
These templates are licensed separately under the MIT License. See
[LICENSE](./LICENSE). Projects created from these templates are not relicensed
under ALCOMD3's AGPL merely because they started from the bundled templates.
