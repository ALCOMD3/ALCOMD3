...
use crate::state::{GuiConfigState, ThemeConfigState};
...
pub fn global_info_json(app: &AppHandle) -> Response<Cow<'static, [u8]>> {
    ...
    let theme_config = app.state::<ThemeConfigState>();
    let theme_config = theme_config.get();
    ...
    let repository_url = crate::alcomd3_config::repository_url();

    let global_info = GlobalInfo {
        language: &config.language,
        theme: &theme_config.theme,
        version: Some(crate::commands::util::ALCOMD3_DISPLAY_VERSION),
        ...
        webview_version,
        app_data,
        homepage_url: crate::alcomd3_config::homepage_url(),
